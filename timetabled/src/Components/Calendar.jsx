      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <Event event="Ghost Pranks" color="blue" />
            <td></td>
            <Event event="Levitation 101" color="pink" />
            <td></td>
            <td></td>
          </tr>
          <tr>
            ...
            <td></td>
            <td></td>
            <Event event="Debate Socrates" color="blue" />
          </tr>
          <tr>
            {" "}
            ...
            <td></td>
            <td></td>
            <Event event="Cosmic Karaoke" color="pink" />
            <td></td>
            <Event event="Speed Dating" color="pink" />
            <td></td>
            <td></td>
          </tr>
          <tr>
            ...
            <td></td>
            <td></td>
            <Event event="Astral Travel" color="green" />
            <td></td>
            <td></td>
          ...
          <tr>
            ...
            <td></td>
            <Event event="Afterlife’s Got Talent" color="blue" />
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td></td>
            <Event event="Meet Cerberus" color="pink" />
            <td></td>
            <td></td>
